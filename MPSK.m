...
The script will also output a desired number of symbols of the random bit array
...
Reference code found from: https://www.mathworks.com/help/comm/ref/comm.pskmodulator-system-object.html
...
modData = mpskModulator(bits); % phase in complex form for each symbol

channelOutput = awgnChannel(modData); % noise 

deModData = mpskDemodulator(channelOutput); % demodulation 
